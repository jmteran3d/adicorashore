...
function solicitarDato(mensaje, validacion) {
    console.log("Se solicitan datos");
    let dato;
    do {
...
function consultarHistorial(){
    let filtro = parseFloat(prompt("Ingresa un monto para buscar créditos similares o deja vacío para ver todo el historial:").trim());
    let resultados = isNaN(filtro) ? historialCreditos : historialCreditos.filter( (x)=> x.monto === filtro);
